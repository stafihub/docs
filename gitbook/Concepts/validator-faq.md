...
The Stafihub is a public Proof-Of-Stake (PoS) blockchain, meaning that the weight of validators is determined by the amount of staking tokens (Fis) bonded as collateral. These Fis can be self-delegated directly by the validator or delegated to them by other Fis holders.
